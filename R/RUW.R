...
#' 
#' With \code{method=='simple'}: Given a numeric vector, find the median, the median 
#' deviation of the lower 50% of cases \code{lowerMAD},
#' and the median deviation of the upper 50% of cases \code{upperMAD}, and scale each asymmetric median
...
#' 
#' As with all functions in the \code{\link{MVNclean}} package, this procedure
#' assumes that a variable could in principle be multivariate normal, and will
#' encounter problems otherwise (e.g., with sharply multimodal variables or
